...
export default function DriverListScreen({ navigation }) {
  ...
  const renderItem = ({ item }) => (
    <View style={styles.card}>
      ...
      <Text style={styles.cardText}>License: {item.license_number}</Text>
      <Text style={styles.cardText}>Phone: {item.phone}</Text>
      <Text style={styles.cardText}>Experience: {item.experience_years} years</Text>
      {item.vehicle_id && (
        <Text style={styles.cardText}>Assigned Vehicle: {item.vehicle_id}</Text>
      )}
