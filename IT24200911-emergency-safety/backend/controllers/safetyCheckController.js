...
exports.createSafetyCheck = async (req, res) => {
  try {
    ...
    const body = { ...req.body };
    if (body.checkItems && typeof body.checkItems === 'object') {
      Object.assign(body, body.checkItems);
      delete body.checkItems;
    }
    if (body.overallStatus == null && body.overall_status != null) {
      body.overallStatus = body.overall_status;
      delete body.overall_status;
    }
